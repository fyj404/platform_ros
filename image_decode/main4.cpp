...
{
    //------------- ROS -------------
    ros::init(argc, argv, "image_decode4");
    ...
    image_transport::Publisher imagePublisher = imageHandle.advertise("camera4/image", 20);
    ...
    localAddress.sin_addr.s_addr = inet_addr("192.168.25.1");
    localAddress.sin_port = htons(5858);
    //------------- socket -------------
